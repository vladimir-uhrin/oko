...
test('satelit: sekcia v jazyku panelu — zdieľa triedu hrozieb, vlastnú značku pre manažér', () => {
  const made = [];
  const doc = { createElement: (tag) => { const el = { tag, className: '', textContent: '', children: [], attrs: {}, appendChild(c) { this.children.push(c); }, setAttribute(k, v) { this.attrs[k] = v; } }; made.push(el); return el; } };
