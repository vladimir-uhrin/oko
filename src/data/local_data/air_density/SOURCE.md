...
- **19,169 gaps bridged**, 13,781,668 synthetic samples = **19.5 %** of all samples; 237,657 cells hold *only* interpolated samples (vs 88,851 with observations). Longest bridged gap 12,601 km. Rejected long gaps: {"notime":0,"slow":3198,"fast":409,"low":1234}.
...
- **Built:** 2026-09-05 by `scripts/build-air-density.mjs`.
...
- Transform: positions **counted** into a 0.25° grid (1440×720), then **log-normalised between a floor and a ceiling**: floor = 60th percentile of non-zero cells (42 samples → transparent background), ceiling = 99.5th (5,073; raw max 199,396, clamped so hubs cannot dim the routes). Painted as RGBA, amber ramp, alpha = intensity^1.4.

## Content
- **Grid:** 1440 × 720 cells of 0.25°
- **Non-zero cells:** 326,508
- **Total samples:** 70,547,026 (observed 56,765,358 + bridged 13,781,668)
- **File size:** ~276 KB (PNG)
